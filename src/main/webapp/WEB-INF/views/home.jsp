...
<tags:page>
  ...
  <jsp:attribute name="tail">
    ...
    <jsp:body>
            ...
            <div class="span12">
                <div id="caro" class="carousel slide">
                    <div class="carousel-inner">
                        ...
                        <div class="item"><img src="img/carousel_daphnia.jpg">
                            <div class="carousel-caption">
                                <a href="${pageContext.request.contextPath}/projects">
        ...
        <span id="by-line">This is the Swedish national portal for animal movement research data, presenting geographical timeseries. Most of the data originates from the <a href="https://www.canmove.lu.se/canmove" target="_blank">CAnMove project</a>.<br>Additional sensor data will be continuously added.</span>
        <hr/>
        <div class="row">
            ...
            <div id="right-panel" class="span3 offset1">
                <div id="stats-div">
                    <h2><a href="https://www.canmove.lu.se/canmove" target="_blank">CAnMove</a> Stats</h2>
                    <ul>
                        <li>112 Datasets</li> 
                        <li>53 Species</li> 
                    ...
                    <p>Movement data in WRAM can be found in the <a href="https://www.slu.se/centrumbildningar-och-projekt/wireless-remote-animal-monitoring-wram/Background/" target="_blank">WRAM database</a></p>
                </div>
                <!--
